          ...
          <div className="flex flex-col items-center justify-center py-20 h-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
              <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                {`Get custom CV's for every job description⚡`}
              </h1>
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                Zero hassel, maximum speed. Make custom professional CV tailored specially to fit the job description.
              </p>
              <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                <Link
                  ...
                  <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                    ✨ {"  "} Make your job application easier now!
                  </p>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-semibold mt-6">Three steps to build your Resume</h2>
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Arslan offers a range of features to help you build a stunning and custom CV in no time
            </p>
          </div>
        </Container>
        <Container>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">Choose the best plan for your business and start building your dream cv today</p>
          </div>
        </Container>
        <Container className="flex items-center justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 w-full md:gap-8 py-10 md:py-20 flex-wrap max-w-4xl">
            {pricingCards.map((card) => (
              <Card
                key={card.title}
                className={cn("flex flex-col w-full border-neutral-700", card.title === "Unlimited Saas" && "border-2 border-primary")}>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              See how Arslan empowers businesses of all sizes. Here&apos;s what real people are saying on Twitter
            </p>
          </div>
        </Container>
        <Container>
          ...
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              ...
              <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                Build stunning cvs with Arslan&apos;s intuitive drag-and-drop builder and powerful AI assistant
              </p>
